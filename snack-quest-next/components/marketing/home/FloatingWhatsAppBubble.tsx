 ...
 */
export function FloatingWhatsAppBubble({ whatsappCustomerNumber }: { whatsappCustomerNumber: string | null }) {
  ...
  return (
    <a
      ...
      className="fixed right-6 bottom-6 z-40 hidden size-16 items-center justify-center rounded-full bg-primary text-white shadow-[0_20px_60px_-15px_rgb(255_122_0/0.5)] transition-transform duration-200 hover:scale-[1.06] md:flex"
    >
