...
/** § SALES & REVENUE — a bar variant of `SalesTrendChart`, for the fuller daily-breakdown view. */
export function DailySalesBarChart({ points }: { points: OwnerSalesTrendPoint[] }) {
  return (
