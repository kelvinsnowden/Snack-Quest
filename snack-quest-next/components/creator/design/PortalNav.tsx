 ...
 * The mobile tab bar.
 *
 * There used to be a raised circular "copy your referral link" button
 * floating in the middle of it, borrowed from the reference apps. On a
 * five-column bar the middle column is Campaigns, and a 56px circle
 * centred on it covered that tab completely — the shortcut made a
 * whole section of the portal unreachable from the bar. Copying the
 * link already lives on the dashboard and the Referrals page, both one
 * tap away, so the shortcut cost more than it saved.
 */
