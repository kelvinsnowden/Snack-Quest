...
export const ADMIN_NAV_ITEMS: AdminNavItem[] = [
  ...
  { href: '/admin/fulfillment-batches', label: 'Fulfillment batches', icon: PackageSearch },
  ...
  { href: '/admin/marketing-emails', label: 'Marketing Emails', icon: Mail },
  { href: '/admin/notification-templates', label: 'Notification Templates', icon: MailPlus },
