...
const { handleReversalResultMock } = vi.hoisted(() => ({ handleReversalResultMock: vi.fn() }));
 ...
 * tests/services/refundService.test.ts; these prove both routes forward
 * the businessId and payload correctly and always ack 200, matching
 * what Daraja expects.
 */
