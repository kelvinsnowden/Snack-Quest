...
class ConversationRepository {
   ...
   * — every conversation for the business, most-recently-active
   * first (not newest-started — a queue for "what needs attention
   * now", not "what started most recently"). Optionally narrowed to
   * one status, e.g. `agent_assigned` for the human agent queue.
   */
