 ...
 * (`ExitIntentOffer.tsx`, `CheckoutForm.tsx`), the public event route
...
export const RESCUE_OFFER_EVENTS = {
  popupShown: 'exit_intent_popup_shown',
  popupDismissed: 'exit_intent_popup_dismissed',
  offerClicked: 'rescue_offer_clicked',
