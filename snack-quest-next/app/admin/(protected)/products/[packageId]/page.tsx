...
export default async function EditAdminProductPage({
  ...
  return (
    <div className="flex max-w-2xl flex-col gap-6">
      <div>
        <h1 className="text-page-title font-bold tracking-tight text-foreground">Edit product</h1>
        <p className="mt-1 text-sm text-muted-foreground">Changes are synced to the WhatsApp catalog automatically.</p>
      </div>
      <ProductForm
        mode="edit"
        packageId={packageId}
