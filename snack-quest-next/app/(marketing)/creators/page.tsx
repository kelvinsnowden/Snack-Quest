...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: 'Join the Snack Quest Creator Program: share your referral link and earn instant commission on every order.',
  path: '/creators',
});
...
const FEATURES = [
  {
    ...
    description: 'Every creator gets a unique link. Share it however you like, every click and order is tracked automatically.',
  },
  {
    icon: Wallet,
      ...
      <section className="border-b border-border bg-surface">
        <div className="mx-auto max-w-4xl animate-fade-in px-4 py-16 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-subtitle text-muted-foreground">
            If you already talk about food, snacks, or good deals online, turn that into income. No minimum
