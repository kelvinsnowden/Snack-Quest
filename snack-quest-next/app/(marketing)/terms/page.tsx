  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <p className="mt-3 text-sm text-muted-foreground">
        These terms cover ordering from {businessName} and joining our Creator Program. By placing an order on
        this website, or by registering as a creator, you agree to them.
      </p>

      <div className="mt-10 flex flex-col gap-10">
        <Section title="Orders">
          <ul className="ml-4 list-disc space-y-1">
            <li>An order is confirmed once you complete the M-Pesa payment prompt sent to your phone at checkout. Until then, nothing is charged and nothing is reserved.</li>
            <li>Prices are shown in Kenyan Shillings (KES) and may change without notice for future orders. The amount charged is the total shown at checkout at the moment you pay.</li>
